...
variable_keys=(
  ...
  VITE_API_BASE_URL
  VITE_SCHEDULER_API
  VITE_AUTH_STATE_CACHE_TTL_HOURS
  VITE_AUTH_SESSION_VALIDATE_INTERVAL_MINUTES
  VITE_AUTH_SESSION_API_BASE_URL
  R2_ACCOUNT_ID
  R2_BUCKET
  R2_ENDPOINT
  R2_PUBLIC_BASE_URL
  ...
  SCHEDULER_ALLOW_UNAUTHENTICATED
  SCHEDULER_LOCK_TTL_MINUTES
  ...
  GCP_PROJECT_ID
  GCP_REGION
  GCP_TEST_CLOUD_RUN_SERVICE
  GCP_CLOUD_RUN_SERVICE
  GCP_CLOUD_RUN_SOURCE
  GCP_RUN_ALLOW_UNAUTHENTICATED
