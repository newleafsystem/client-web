          ...
          <div className="hero-inner">
            ...
            <div>
              <div className="hero-pill">
                ...
                Five-App Options Ecosystem
              </div>

              <h1>One system.<br/><em>Every step</em><br/>of the trade.</h1>

              <p className="hero-sub">
                From quant research to live execution — five specialised apps sharing
                a single connected hub. Structured, repeatable, defined-risk options trading
                with no gaps in the pipeline.
              </p>

              <div className="hero-ctas">
                <button className="btn-primary" onClick={() => handleGetStarted('signup')}>Get Started Free →</button>
                <button className="btn-secondary" onClick={() => document.getElementById('apps')?.scrollIntoView({ behavior: 'smooth' })}>Watch Demo</button>
              </div>

              <div className="hero-metrics">
                <div className="hm-item">
                  <div className="hm-val">5</div>
                  <div className="hm-label">Applications</div>
                </div>
                <div className="hm-div"></div>
                <div className="hm-item">
                  <div className="hm-val">150+</div>
                  <div className="hm-label">Symbols scanned</div>
                </div>
                <div className="hm-div"></div>
                <div className="hm-item">
                  <div className="hm-val">3</div>
                  <div className="hm-label">Scoring pillars</div>
                </div>
                <div className="hm-div"></div>
                <div className="hm-item">
                  <div className="hm-val">1</div>
                  <div className="hm-label">Shared data hub</div>
                </div>
              </div>
            </div>

            {/* Right: System diagram SVG */}
        ...
        <div className="wrap">
          ...
          <div className="video-shell" style={{maxWidth: '900px', margin: '0 auto', background: 'var(--card)', borderRadius: 'var(--r4)', overflow: 'hidden', boxShadow: 'var(--s2)', border: '1px solid var(--bdr)'}}>
            ...
            <div className="video-body">
              ...
              >
                <source src="https://pub-554c552d94e74e32822dd23be2656ba0.r2.dev/NewLeafSystemOverview.mp4" type="video/mp4" />
